...
def get_training_data():
    return __get_data(os.getcwd() + "/synthetic_data/training/", PERSON_TABLES)

def get_testing_data():
    return __get_data(os.getcwd() + "/synthetic_data/testing/", PERSON_TABLES)

def get_concept_data():
    return __get_data(os.getcwd() + "/synthetic_data/", CONCEPT_TABLES)
