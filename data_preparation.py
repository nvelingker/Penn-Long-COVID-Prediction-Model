...
def get_training_data():
    ...
    return __get_data(os.path.join(root_dir, "synthetic_data/training/"), PERSON_TABLES)

def get_testing_data():
    # return __get_data(os.getcwd() + "/Penn-Long-COVID-Prediction-Model/synthetic_data/testing/", PERSON_TABLES)
    return __get_data(os.path.join(root_dir, "synthetic_data/testing/"), PERSON_TABLES)

def get_concept_data():
    # return __get_data(os.getcwd() + "/Penn-Long-COVID-Prediction-Model/synthetic_data/", CONCEPT_TABLES)
    return __get_data(os.path.join(root_dir, "synthetic_data/"), CONCEPT_TABLES)    
